...
## 生产实践：Vuex 3.x 中的单例模式

> 以下基于 vuex 3.x 版本，4.x版本可以 createStore 创建多个实例
...
关于 Vuex 的细节，大家可以参考 [Vuex的官方文档](https://v3.vuex.vuejs.org/zh/)，此处提及 Vuex，除了为了拓宽大家的知识面，更重要的是为了说明单例模式在生产实践中广泛的应用和不可或缺的地位。如果对 Vuex 没有兴趣，那么大家只需关注“一个 Vue 实例只能对应一个 Store”这一点即可。
...
在 [install](https://github.com/vuejs/vuex/blob/3.x/src/store.js#L539) 方法里，有一段逻辑和我们楼上的 `getInstance` 非常相似的逻辑：
