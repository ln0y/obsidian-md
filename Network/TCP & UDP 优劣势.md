---
aliases: []
tags: ['TCP','UDP','Network','date/2022-04','year/2022','month/04']
date: 2022-04-15-Friday 17:46:27
update: 2022-04-15-Friday 17:47:11
---
...
如果你打开 [TCP 协议的 RFC 文档](https://tools.ietf.org/html/rfc793?fileGuid=xxQTRXtVcqtHK6j8)，可以看到目录中一共有 85 页；如果你打开 [UDP 的 RFC 文档](https://tools.ietf.org/html/rfc768?fileGuid=xxQTRXtVcqtHK6j8)，会看到目录中只有 3 页。一个只有 3 页的协议，能够成为今天最主流的传输层协议之一，那么它一定有非常值得我们学习的地方。

UDP 在数据传输、网络控制、音视频、Web 技术中，都有很重要的地位，因此它也是面试常考的内容。设计系统时候，UDP 经常拿来和 TCP 比较。
...
![[Cgp9HWCCfQeAGOF3AACK2Gf5t6I606.png|800]]
...
我们针对 UDP 协议的内容进行了探讨，到这里互联网协议群的传输层讲解就结束了。协议对于我们来说是非常重要的，协议的制定让所有参与者一致、有序地工作。
...
从程序架构上来说，今天我们更倾向于简单专注的设计，我们更期望有解决报文传输的工具、有解决可靠性的工具、有解决流量控制的工具、有解决连接和会话的工具——由大量优质的工具逐渐取代历史上沉淀下来完整统一的系统。

那么 TCP 协议和 UDP 协议的优势和劣势都有什么？
