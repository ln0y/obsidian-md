...
![[_attachment/img/13aa8cdd72ddd78ca5cfe10815ba3b5f_MD5.gif]]
...
![[_attachment/img/19fe01824e7ac192cb196a97214f751a_MD5.png]]
...
当然，我们也可以像前面中介绍过 `vw` 设置 `font-size` 的方法一样，使用容器查询单位来给卡片组件标题设置 `font-size`：
...
![[_attachment/img/34e6981c87233fac880e775dace616f9_MD5.png]]
...
![[_attachment/img/a39f973726e5c3ab823e55fb7e6ae4dd_MD5.gif]]
...
> [CSS Containment Module Level 3 规范](https://drafts.csswg.org/css-contain-3/) （当前还只是工作草案）定义了样式查询。
...
![[_attachment/img/8f3b65ba2ce77f7a774ce961f5c765bb_MD5.png]]
...
![[_attachment/img/e740ff4f7d44a933990fa7b64105e7e4_MD5.png]]
...
![[_attachment/img/1482a6c2ae63239e7a721f5194325961_MD5.png]]
...
![[_attachment/img/a656d0ecd9629a9bb1ed741a7607b01f_MD5.gif]]
...
![[_attachment/img/26aae912b7c718f59ce246014c6ffb9e_MD5.gif]]
...
![[_attachment/img/3c5a1a116301867f47c822f6acd35905_MD5.gif]]

上面示例是容器查询和样式查询组合在一起的。你可能还没有体会到样式查询所起的作用。那我们来看两个纯样式查询的示例。比如下图这个布局效果：

![[_attachment/img/0dc180365c4298176bc227cd426f4678_MD5.png]]
...
![[_attachment/img/5745f98ebccb15fb365d02ca71580ee0_MD5.png]]
...
![[_attachment/img/471b9f0f52c2ce5406346ec0446c91a4_MD5.png]]

> Demo 地址：<https://codepen.io/airen/full/bGjqRrg> （请使用 Chrome Canary 查看 ）

我们在[[web 中的 LTR 和 RTL]]和[[LTR 切换到 RTL 的常见错误]]有详细介绍过如何实现上图这样的多语言 Web 组件，所以这里就不再重复阐述。我们直接来看，有了样式查询之后，它是如何实现的？
...
>
  <div class="card">
    ...
    <p>
      الدرس الأخير في تصميم Web الحديثة، والجيل التالي من استجابة الحاويات في تصميم Web،
      هو البحث عن الحاويات!
    </p>
    <span
      ><svg
        t="1673340802729"
