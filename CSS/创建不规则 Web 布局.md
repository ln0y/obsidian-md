...
文章开头提到 @Andy Clarke 在他的文章《[Art Direction For The Web Using CSS Shapes](https://www.smashingmagazine.com/2019/04/art-direction-for-the-web-using-css-shapes/)》向大家展示了很多有意思的不规则 Web 布局。比如 **V 字型布局** 、**Z 字型布局** 、**曲线布局** 、**对角线形状布局** 、**旋转布局** 和 **任意图像定义的布局** 等。我们就先以 V 字型布局为例。
