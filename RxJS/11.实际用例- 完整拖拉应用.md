...
在 [[08.简易拖拉实现- take, first, takeUntil, concatAll|第 08 篇]] 的时候，我们已经成功做出简易的拖拉效果，今天要来做一个完整的应用，而且是实际上有机会遇到但不好处理的需求，那就是优酷的影片效果！
...
这里我们用到了 `getBoundingClientRect` 这个浏览器原生的 API，他可以取得 DOM 对象的宽高以及上下左右离屏幕可视区间上 (左) 的距离，如下图
