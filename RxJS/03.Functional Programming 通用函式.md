...
forEach 是 FP 操作数组的基本方法，我们可以用这个方法来实现下面三个我们今天要讲的重点分别为 map, filter, concatAll。
...
到这里我们就实现完成 map 的方法了，让我们来试试这个方法吧！
...
可以看到上面的代码，我们用了较为低阶的操作来解决这个问题，我们刚刚已经试着用抽象化的方式实现了 map 跟 filter，那我们同样也能够定义一个方法用来摊平二维数组。
...
练习链接：[JSBin](https://jsbin.com/wifulas/6/edit?js,output) | [JSFiddle](https://jsfiddle.net/s6323859/5wcgnf89/1/)

这题有点难，大家可以想想看，我把答案写在 [这里](https://jsbin.com/rahezacane/edit?js,console) 了！

如果大家还想做更多的练习可以到这个链接：[http://reactivex.io/learnrx/](http://reactivex.io/learnrx/)
